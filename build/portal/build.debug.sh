...
execute "dotnet publish --no-restore --configuration Debug /m /v:m /p:BuildFrontendBackend=false /p:BuildPortForwarding=false /p:BuildPortal=true /p:BuildTokenService=false /p:BuildOtherServices=false /p:BuildOps=false $REPO_ROOT/dirs.proj"
