...
namespace Microsoft.VsCloudKernel.SignalService.PresenceServiceHubTests
{
    ...
    public abstract class ContactBackplaneProviderTests : TestBase, IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            await this.backplaneProvider.UpdateMetricsAsync(new ServiceInfo("serviceId", null, null), default, default);
        }
