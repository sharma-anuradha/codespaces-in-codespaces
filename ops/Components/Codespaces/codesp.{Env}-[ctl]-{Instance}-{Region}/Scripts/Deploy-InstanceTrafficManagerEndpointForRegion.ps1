...
# Constants
$clusterIpAddressName = "{{{clusterName}}}-ip"
$clusterResourceGroup = "{{{baseRegionName}}}"
$endpointLocation = "{{{location}}}"
$endpointName = $endpointLocation.ToLowerInvariant()
$endpointType = "AzureEndpoints"
$geoMappings = "{{{trafficManagerEndpointGeoMappings}}}" -split ' '
$profileName = "{{{baseInstanceName}}}-tm"
$profileResourceGroup = "{{{baseInstanceName}}}"
