# script parameters
SCRIPT_PARAM_GCS_ENVIRONMENT='__REPLACE_GCS_ENVIRONMENT__'
SCRIPT_PARAM_GCS_ACCOUNT='__REPLACE_GCS_ACCOUNT__'
SCRIPT_PARAM_GCS_NAMESPACE='__REPLACE_GCS_NAMESPACE__'
SCRIPT_PARAM_GCS_ROLE='__REPLACE_GCS_ROLE__'
SCRIPT_PARAM_GCS_TENANT='__REPLACE_GCS_TENANT__'
SCRIPT_PARAM_GCS_PFX_BASE64='__REPLACE_GCS_PFX_BASE64__'
...
# Set up data disk
sfdisk -l
DISK_NAME=`sfdisk -l | grep '1 TiB' -m 1| cut -d' ' -f2| cut -d':' -f1` \
