...
# Constants
$clusterIpAddressName = "vscs-codesp-prod-rel-ap-se-cluster-v1-ip"
$clusterResourceGroup = "vscs-codesp-prod-rel-ap-se"
$endpointLocation = "SoutheastAsia"
$endpointName = $endpointLocation.ToLowerInvariant()
$endpointType = "AzureEndpoints"
$geoMappings = "GEO-AS GEO-AP" -split ' '
