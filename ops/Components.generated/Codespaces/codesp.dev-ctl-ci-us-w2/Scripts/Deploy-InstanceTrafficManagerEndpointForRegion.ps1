...
# Constants
$clusterIpAddressName = "vscs-codesp-dev-ci-us-w2-cluster-v1-ip"
$clusterResourceGroup = "vscs-codesp-dev-ci-us-w2"
$endpointLocation = "WestUs2"
$endpointName = $endpointLocation.ToLowerInvariant()
$endpointType = "AzureEndpoints"
$geoMappings = "WORLD GEO-NA GEO-AS GEO-SA GEO-AP" -split ' '
$profileName = "vscs-codesp-dev-ci-tm"
$profileResourceGroup = "vscs-codesp-dev-ci"
