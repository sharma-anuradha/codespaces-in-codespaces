...
function Main() {
  ...
  if (Select-Subscription) {
    Write-Host "Getting credentials for 'vscs-codesp-dev-ci-us-w2-cluster-v1'" -ForegroundColor DarkGray
    Import-AzAksCredential -ResourceGroupName 'vscs-codesp-dev-ci-us-w2' -Name 'vscs-codesp-dev-ci-us-w2-cluster-v1' -Force -Verbose:$script:Verbose

    Write-Host "Installing chart '$chartName' to 'vscs-codesp-dev-ci-us-w2-cluster-v1' in namespace 'default'" -ForegroundColor green
