...
# Constants
$clusterIpAddressName = "vscs-codesp-prod-rel-us-w2-cluster-v1-ip"
$clusterResourceGroup = "vscs-codesp-prod-rel-us-w2"
$endpointLocation = "WestUs2"
$endpointName = $endpointLocation.ToLowerInvariant()
$endpointType = "AzureEndpoints"
$geoMappings = "WORLD UM US CA CA-AB CA-BC CA-MB CA-NT CA-NU CA-SK CA-YT US-AK US-AZ US-CA US-CO US-HI US-ID US-KS US-MT US-ND US-NE US-NM US-NV US-OK US-OR US-SD US-TX US-UT US-WA US-WY" -split ' '
