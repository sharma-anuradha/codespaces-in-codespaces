...
namespace Microsoft.VsCloudKernel.SignalService.Client
{
    ...
    /// </summary>
    public class ContactServiceProxy : IContactServiceProxy
    {
        /// <summary>
        ...
        {
            var result = await this.hubProxy.InvokeAsync<JObject>(nameof(IContactServiceHub.GetSelfConnectionsAsync), new object[] { contactId }, cancellationToken);
        ...
        {
            var registerProperties = await this.hubProxy.InvokeAsync<Dictionary<string, object>>(nameof(IContactServiceHub.RegisterSelfContactAsync), new object[] { contactId, initialProperties }, cancellationToken);
        ...
        {
            return this.hubProxy.InvokeAsync(nameof(IContactServiceHub.PublishPropertiesAsync), new object[] { updateProperties }, cancellationToken);
        }
        ...
        {
            return this.hubProxy.InvokeAsync(nameof(IContactServiceHub.SendMessageAsync), new object[] { targetContact, messageType, body }, cancellationToken);
        }
        ...
        {
            var result = await this.hubProxy.InvokeAsync<JObject>(nameof(IContactServiceHub.AddSubcriptionsAsync), new object[] { targetContacts, propertyNames }, cancellationToken);
        ...
        {
            var jArray = await this.hubProxy.InvokeAsync<JArray>(nameof(IContactServiceHub.RequestSubcriptionsAsync), new object[] { targetContactProperties, propertyNames, useStubContact }, cancellationToken);
        ...
        {
            return this.hubProxy.InvokeAsync(nameof(IContactServiceHub.RemoveSubscription), new object[] { targetContacts }, cancellationToken);
        }

        /// <inheritdoc/>
        public Task UnregisterSelfContactAsync(CancellationToken cancellationToken)
        {
            return this.hubProxy.InvokeAsync(nameof(IContactServiceHub.UnregisterSelfContactAsync), new object[] { }, cancellationToken);
        }
        ...
        {
            var results = await this.hubProxy.InvokeAsync<JArray>(nameof(IContactServiceHub.MatchContactsAsync), matchingProperties, cancellationToken);
        ...
        {
            var result = await this.hubProxy.InvokeAsync<JObject>(nameof(IContactServiceHub.SearchContactsAsync), new object[] { searchProperties, maxCount }, cancellationToken);
            return result.ToPropertyDictionary();
        }
