// <copyright file="ConnectionErrorsSessionClientProvider.cs" company="Microsoft">
...
{
    /// <summary>
    /// Provides access to lazy loaded singleton <see cref="ISessionClient" /> for connections-errors queue.
    /// </summary>
    public class ConnectionErrorsSessionClientProvider : ServiceBusSessionClientProviderBase, IConnectionErrorsSessionClientProvider
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionErrorsSessionClientProvider"/> class.
        /// </summary>
        /// <param name="serviceBusClientProvider">The service bus client provider.</param>
        /// <param name="loggerFactory">The logger factory.</param>
        /// <param name="defaultLogValues">The default log values.</param>
        public ConnectionErrorsSessionClientProvider(
