    ...
    public class ValidatedPrincipalIdentityHandler : IValidatedPrincipalIdentityHandler
    {
        ...
        private void DebugWriteIdentityInfo(ClaimsIdentity identity)
        {
            ...
            if (HostingEnvironment.IsDevelopment())
            {
                ...
                var currentUserProvider_GetProfile_Id = currentUserProvider.GetProfile()?.Id;
                var currentUserProvider_GetProfile_ProviderId = currentUserProvider.GetProfile()?.ProviderId;
                var currentUserProvider_GetProfile_Name = currentUserProvider.GetProfile()?.Name;
                var currentUserProvider_GetProfile_Email = currentUserProvider.GetProfile()?.Email;
                var currentUserProvider_GetProfile_UserName = currentUserProvider.GetProfile()?.UserName;
