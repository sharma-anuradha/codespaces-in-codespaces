...
const reducers = { authentication, configuration, environments, __test };
...
type AcceptedActions = ReducersToAcceptedActions<typeof reducers>;
...
type r = BaseActionAcceptingReducer<typeof reducers>;
