...
import { vslsTypes } from 'vso-client-core';
 ...
 */
export class SharedServiceImp implements vslsTypes.SharedService, vslsTypes.SharedServiceProxy {
    ...
    public onRequest(name: string, handler: vslsTypes.RequestHandler): void {
    ...
    public onNotify(name: string, handler: vslsTypes.NotifyHandler): void {
        const rpcName = this.makeRpcName(name);
