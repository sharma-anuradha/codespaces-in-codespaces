...
namespace Microsoft.VsCloudKernel.Services.Portal.WebSite.Test.Controllers
{
    ...
    public class PlatformAuthControllerSalesforceTests
    {
        ...
        [InlineData("https://subdomain1.lightning.force.com", "oneId.ppe.builder.code.com", false, false)]
        [InlineData("https://subdomain1.lightning.force.com", "otherId.ppe.builder.code.com", false, false)]
        // - dev
