// <copyright file="PublicAppUsingDeviceCodeFlow.cs" company="Microsoft">
...
{
    /// <summary>
    /// Copied from: https://github.com/Azure-Samples/active-directory-dotnetcore-devicecodeflow-v2/blob/master/device-code-flow-console/PublicAppUsingDeviceCodeFlow.cs.
    /// </summary>
    public class PublicAppUsingDeviceCodeFlow
    {
        ...
        /// <summary>
        /// Gets public Client Application instance.
        /// </summary>
        ...
        public async Task<AuthenticationResult> AcquireATokenFromCacheOrDeviceCodeFlowAsync(IEnumerable<string> scopes, TextWriter stdout)
        {
            ...
            if (result == null)
            {
                result = await GetTokenForWebApiUsingDeviceCodeFlowAsync(scopes, stdout);
            }
        ...
        private async Task<AuthenticationResult> GetTokenForWebApiUsingDeviceCodeFlowAsync(IEnumerable<string> scopes, TextWriter stdout)
        {
            ...
            try
            {
                result = await App.AcquireTokenWithDeviceCode(
                    ...
                    deviceCodeCallback =>
                    {
                        ...
                        stdout.WriteLine(deviceCodeCallback.Message);
