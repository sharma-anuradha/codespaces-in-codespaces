...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.Common.Contracts
{
    ...
    public interface IClientFactory
    {
        ...
        Task<IAzure> GetAzureClientAsync(Guid subscriptionId, IDiagnosticsLogger logger = default);
        ...
        /// <param name="logger">The logger instance.</param>
        /// <returns>Azure client.</returns>
        Task<INetworkManagementClient> GetNetworkManagementClient(Guid subscriptionId, IDiagnosticsLogger logger);
