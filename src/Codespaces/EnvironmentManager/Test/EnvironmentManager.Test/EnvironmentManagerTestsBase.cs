...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.EnvironmentManager.Test
{
    public class EnvironmentManagerTestsBase
    {
        ...
        public readonly IResourceAllocationManager resourceAllocationManager;
        ...
        public EnvironmentManagerTestsBase()
        {
            ...
            this.heartbeatRepository = new MockCloudEnvironmentHeartbeatRepository();
            ...
            this.environmentStateManager = new EnvironmentStateManager(billingSettings.Object, workspaceManager, environmentRepository, billingEventManager, environmentStateChangeManager, metricsLogger);

            var serviceProviderMock = new Mock<IServiceProvider>();
            serviceProviderMock.Setup(x => x.GetService(typeof(IEnvironmentMonitor))).Returns(environmentMonitor);
