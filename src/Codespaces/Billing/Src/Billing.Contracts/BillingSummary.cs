...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.Billing
{
    ...
    public class BillingSummary
    {
        ...
        /// <summary>
        /// Gets or sets SkuPlan plan used for this billing period.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Gets or sets state of the subscription during this billing period.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets if this billing data was emitted so that the customer will actually get
        ...
        /// <summary>
        /// Gets or sets if this billing data was queued for partner.
        /// </summary>
        [JsonProperty(Required = Required.Default, PropertyName = "partnerSubmissionState")]
        public BillingSubmissionState PartnerSubmissionState { get; set; }
