...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.ResourceBroker.Tasks
{
    ...
    public class WatchOrphanedComputeImagesTask : BaseBackgroundTask
    {
        ...
        {
            if (await JobSchedulerFeatureFlags.IsFeatureFlagEnabledAsync(WatchOrphanedComputeImagesJobProducer.FeatureFlagName, WatchOrphanedComputeImagesJobProducer.DefaultEnabled))
            {
                return null;
            }
