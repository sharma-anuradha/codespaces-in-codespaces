...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.ResourceBroker.Tasks
{
    ...
    public class WatchOrphanedComputeImagesTask : BaseBackgroundTask
    {
        ...
        {
            // if WatchOrphanedComputeImagesJob feature flag is on, it should never obtain the lease for the old deprecated task
            if (await JobSchedulerFeatureFlags.IsFeatureFlagEnabledAsync(WatchOrphanedComputeImagesJobProducer.FeatureFlagName))
            {
                return null;
            }
