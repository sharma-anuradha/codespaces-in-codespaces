...
{
    /// <inheritdoc/>
    public class ArchiveStorageProvider : SharedStorageProvider, IArchiveStorageProvider
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        protected override string StorageInitStorageAccountMessageLog => "archive_storage_init_storage_account";

        /// <inheritdoc/>
        protected override string StorageCapacityMessageLog => "archive_storage_capacity";

        /// <inheritdoc/>
        public Task<ISharedStorageInfo> GetArchiveStorageAccountAsync(
        ...
        /// <inheritdoc/>
        public Task<IEnumerable<ISharedStorageInfo>> ListArchiveStorageAccountsAsync(AzureLocation location, IDiagnosticsLogger logger)
        {
        ...
        public override string GetStorageAccountName(AzureLocation location, int index)
        {
            ...
            storageAccountName = ResourceNameBuilder.GetStorageAccountName(storageAccountName, "as");
