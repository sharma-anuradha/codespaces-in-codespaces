// <copyright file="ISharedStorageProvider.cs" company="Microsoft">
...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.SharedStorageProvider.Contracts
{
    ...
    public interface ISharedStorageProvider
    {
        ...
        /// </remarks>
        Task<ISharedStorageInfo> GetStorageAccountAsync(AzureLocation location, int minimumRequiredGB, IDiagnosticsLogger logger, bool forceCapacityCheck = false);
        ...
        Task<IEnumerable<ISharedStorageInfo>> ListStorageAccountsAsync(AzureLocation location, IDiagnosticsLogger logger);
    }
}
