// <copyright file="IExportStorageProvider.cs" company="Microsoft">
...
{
    /// <summary>
    /// Manages system storage accounts used for exporting environment file storage.
    /// </summary>
    public interface IExportStorageProvider : ISharedStorageProvider
    {
        /// <summary>
        /// Gets an export storage account in the specified region having the minimum required available GB of storage.
        /// </summary>
        ...
        /// </remarks>
        Task<ISharedStorageInfo> GetExportStorageAccountAsync(AzureLocation location, int minimumRequiredGB, IDiagnosticsLogger logger, bool forceCapacityCheck = false);

        /// <summary>
        /// Lists the export storage accounts that exist in the specified azure location.
        /// </summary>
        /// <param name="location">The azure location.</param>
        /// <param name="logger">The diagnostics logger.</param>
        /// <returns>A list of <see cref="ISharedStorageInfo"/>.</returns>
        Task<IEnumerable<ISharedStorageInfo>> ListExportStorageAccountsAsync(AzureLocation location, IDiagnosticsLogger logger);
    }
}
