...
export module Links {
    export const visualStudioCodespaces = "https://visualstudio.microsoft.com/services/visual-studio-codespaces/";
    export const visualStudioCodespacesEnvironments = "https://online.visualstudio.com/environments";
    export const learnMoreConsistency =
        "https://aka.ms/portalfx/designpatterns";
