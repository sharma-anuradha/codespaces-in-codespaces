...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.Capacity.Contracts
{
    ...
    {
        /// <summary>
        /// Gets the the resource usage for the given subscription, location, and resource type.
        /// </summary>
        ...
        /// <summary>
        /// Updates the resource useage for the given subscription, location, and resource type.
        /// </summary>
        /// <param name="subscription">The azure subscription.</param>
        /// <param name="location">The azure location.</param>
        /// <param name="serviceType">The azure service type.</param>
