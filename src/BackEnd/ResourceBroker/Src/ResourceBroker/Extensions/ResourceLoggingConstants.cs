...
namespace Microsoft.VsSaaS.Services.CloudEnvironments.ResourceBroker.Extensions
{
    ...
    public class ResourceLoggingConstants
    {
        ...
        /// <summary>
        /// Initialize Continuation Task Message Handler name.
        /// </summary>
        public const string ContinuationTaskMessageHandlerInitialize = "continuation_task_message_handler_initialize";
    }
}
