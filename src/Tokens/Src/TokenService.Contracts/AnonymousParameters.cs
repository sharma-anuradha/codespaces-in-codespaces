// <copyright file="AnonymousParameters.cs" company="Microsoft">
...
namespace Microsoft.VsSaaS.Services.TokenService.Contracts
{
    ...
    public class AnonymousParameters
    {
        ...
        /// <summary>
        /// Gets or sets the optional requested display name for the resulting token.
        /// </summary>
        /// <remarks>
        /// If unspecified, no display name claim will be included.
        /// </remarks>
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.Ignore)]
